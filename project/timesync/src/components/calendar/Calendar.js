...
import { getEvents, deleteEvent, addEvent, updateEvent } from "../../actions/events";
    ...
    render() {
        return (
            <Fragment>
                ...
                <Modal isOpen={this.state.modalVisibility.edit} toggle={this.toggleEditModal}>
                    <Form>
                        ...
                        <ModalBody>
                            ...
                            <FormGroup row>
                                ...
                                <Col sm={6}>
                                    <Input type="date" defaultValue={this.state.event.startDate}
                                        onChange={e => {
                                            this.state.event.start = new Date(`${e.target.value} ${this.state.event.startTime}`);
                                ...
                                <Col sm={4}>
                                    <Input type="time" defaultValue={this.state.event.startTime}
                                        onChange={e => {
                                            this.state.event.start = new Date(`${this.state.event.startDate} ${e.target.value}`);
                            ...
                            <FormGroup row>
                                ...
                                <Col sm={6}>
                                    <Input type="date" name="endDate" defaultValue={this.state.event.endDate}
                                        onChange={e => {
                                            this.state.event.end = new Date(`${e.target.value} ${this.state.event.endTime}`);
                                ...
                                <Col sm={4}>
                                    <Input type="time" name="endTime" defaultValue={this.state.event.endTime}
                                        onChange={e => {
                                            this.state.event.end = new Date(`${this.state.event.endDate} ${e.target.value}`);
                        ...
                        <ModalFooter>
                            <Button className="mr-auto" color="danger" onClick={this.onEventDelete}>Delete</Button>
                            <Button color="secondary" onClick={this.toggleEditModal}>Cancel</Button>
                            <Button color="primary" onClick={this.onEventEdit}>Save</Button>
                        </ModalFooter>
                    </Form>
                </Modal>

                <Modal isOpen={this.state.modalVisibility.create} toggle={this.toggleCreateModal}>
                    <Form>
                        ...
                        <ModalBody>
                            ...
                            <FormGroup row>
                                ...
                                <Col sm={6}>
                                    <Input type="date" defaultValue={this.state.event.endDate}
                                        onChange={e => {
                                            this.state.event.end = new Date(`${e.target.value} ${this.state.event.endTime}`);
                                            this.state.event.endDate = e.target.value;
                                        }}>
                        ...
                        <ModalFooter>
                            ...
                            <Button color="primary" onClick={this.onEventCreate}>Create</Button>
                        </ModalFooter>
                    </Form>
                </Modal>
            </Fragment>
